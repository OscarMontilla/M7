...
class User {
        ...
        public function Save() {
                if (isset($this->ID)) {
                        ...
                        $objStatement->execute();
                        logMessage("Se ha actualizado el usuario" .$ID ."\n", 75);
                } else {
                        $strValueList = "";
        ...
        public function MarkForDeletion() {
                ...
                logMessage("Marcamos el usuario que queremos borrar\n", 50);
        }
        ...
        private function SetAccessor($strMember, $strNewValue) {
                if (property_exists($this, $strMember)) {
                        ...
                        logMessage("Llamada a la funcion SetAcessor\n", 10);
                } else {
                        return(false);
                };
        }
        ...
        private function GetAccessor($strMember) {
                if (property_exists($this, $strMember)) {
                        ...
                        return($strRetVal);
                        logMessage("Llamada a la funcion GetAcessor \n", 5);
                } else {
                        return(false);
                };
        }
