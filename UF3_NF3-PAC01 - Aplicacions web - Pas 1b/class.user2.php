...
class User {
        ...
        public function Save() {
                if (isset($this->ID)) {
                        ...
                        $log->logMessage("Se ha actualizado el usuario" .$ID ."\n", Logger::INFO);
                } else {
                        $strValueList = "";
                        ...
                        $this->ID = $this->objPDO->lastInsertId
                                                 ...
                                                 $log = Logger::getInstance();
                                                 $log->logMessage("SE HA INSERTADO" .$ID ."\n", Logger::DEBUG);
                }
        }
        ...
        public function MarkForDeletion() {
                ...
                $log = Logger::getInstance();
                $log->logMessage("Marcamos el usuario que queremos borrar\n", Logger::NOTICE);
        }
        ...
        public function __destruct() {
                ...
                $log = Logger::getInstance();
                $log->logMessage("Usuario borrado " ."\n", Logger::WARNING);
        }
        ...
        private function SetAccessor($strMember, $strNewValue) {
                if (property_exists($this, $strMember)) {
                        ...
                        $log = Logger::getInstance();
                        $log->logMessage("Llamada a la funcion SetAcessor\n", Logger::ERROR);
                } else {
                        return(false);
                };
        }
        ...
        private function GetAccessor($strMember) {
                if (property_exists($this, $strMember)) {
                        ...
                        return($strRetVal);
                        $log = Logger::getInstance();
                        $log->logMessage("Llamada a la funcion GetAcessor \n", Logger::CRITICAL);
                } else {
                        return(false);
                };
        }
