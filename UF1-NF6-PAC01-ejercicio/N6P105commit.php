...
case 'add':
    ...
    case 'movie':
        ...
        if (empty($error)) {
          ...
          $errorFormulario = join('<br/>', array_map('urlencode', $error));
          header('Location:N6P104movie.php?action=add' . '&error=' . $errorFormulario);
        }
        break;
    ...
    case 'people':
        ...
        if (empty($error)) {
            ...
            $errorFormulario = join('<br/>', array_map('urlencode', $error));
            header('Location: people.php?action=add' . '&error=' . $errorFormulario);
        }
        break;
...
case 'edit':
    ...
    case 'movie':
        ...
        if (empty($error)) {
          ...
          $errorFormulario = join('<br/>', array_map('urlencode', $error));
          header('Location:N6P104movie.php?action=edit&id=' . $_POST['movie_id'] . '&error=' . $errorFormulario);
        }
        break;
